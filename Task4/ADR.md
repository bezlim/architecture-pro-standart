...
| NFR4 | Защита персональных данных — ставки не содержат ПДн, но трафик шифруется |
| NFR5 | Использование существующих технологий — Kafka, Java Spring Boot |
| NFR6 | Автоматическая генерация и отправка файлов — без ручного вмешательства |
| NFR7 | Мониторинг доставки файлов — логирование успешных/неуспешных отправок |
| NFR8 | Горизонтальное масштабирование кол-центра — Java Spring Boot микросервисы |
...
Исходный файл: [diagrams/context_diagram.puml](diagrams/context_diagram.puml)

#### Диаграмма компонентов

![Диаграмма компонентов](diagrams/component_diagram.png)

Исходный файл: [diagrams/component_diagram.puml](diagrams/component_diagram.puml)
